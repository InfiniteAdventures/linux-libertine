...
if fnt.fontname == "LinLibertineO":
   ...
   filename = "LinBiolinum_It"
   fnt.familyname = "Linux Biolinum O"
   fnt.fullname = "Linux Biolinum O Italic"
   fnt.weight = "Book"
...
if fnt.fontname == "LinLibertineO":
   ...
   newfontname = "LinLibertineSlantedO"
   fnt.familyname = "Linux Libertine Slanted O"
   fnt.fullname = "Linux Libertine Slanted O"
   fnt.weight = "Book"
elif fnt.fontname == "LinLibertineOB":
   filename = "LinLibertine_BSl"
   newfontname = "LinLibertineSlantedOB"
   fnt.familyname = "Linux Libertine Slanted O"
   fnt.fullname = "Linux Libertine Slanted O Bold"
   fnt.weight = "Bold"
elif fnt.fontname == "LinBiolinumO":
   filename = "LinBiolinum_Sl"
   newfontname = "LinBiolinumSlantedO"
   fnt.familyname = "Linux Biolinum Slanted O"
   fnt.fullname = "Linux Biolinum Slanted O"
   fnt.weight = "Book"
elif fnt.fontname == "LinBiolinumOB":
   filename = "LinBiolinum_BSl"
   newfontname = "LinBiolinumSlantedOB"
   fnt.familyname = "Linux Biolinum Slanted O"
   fnt.fullname = "Linux Biolinum Slanted O Bold"
   fnt.weight = "Bold"
